...
* Using modules
* Support
* (Possibly job arrays - keeps the paralleling out of R (see slide below)
* etc. 

(It'd be good to do a quick demo here - logging on, submitting a job;
could use the job script I used for the benchmarking)
...
* CSF lets us handle bigger jobs
